...
const moleculeDefinitions = {
  ...
  H_2_O_2: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('H_2_O_2')),
    unlocked: false,
    description: 'H-O-O-H'
  },
  Na_Cl: {
  ...
  C_2_H_6: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_2_H_6')),
    unlocked: false,
  ...
  C_2_H_5_O_H: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_2_H_5_O_H')),
    unlocked: false,
  ...
  C_H_3_O_H: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_H_3_O_H')),
    unlocked: false,
  ...
  H_2_S_O_4: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('H_2_S_O_4')),
    unlocked: false,
  ...
  C_6_H_6: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_6_H_6')),
    unlocked: false,
...
,
  C_6_H_12_O_6: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_6_H_12_O_6')),
    unlocked: false,
  ...
  C_12_H_22_O_11: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_12_H_22_O_11')),
    unlocked: false,
  ...
  C_2_H_4_O_2: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_2_H_4_O_2')),
    unlocked: false,
  ...
  C_2_H_2: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_2_H_2')),
    unlocked: false,
  ...
  C_3_H_8: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_3_H_8')),
    unlocked: false,
  ...
  C_3_H_8_O_3: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_3_H_8_O_3')),
    unlocked: false,
  ...
  Ca_C_O_3: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('Ca_C_O_3')),
    unlocked: false,
  ...
  Fe_2_O_3: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('Fe_2_O_3')),
    unlocked: false,
  ...
  H_N_O_3: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('H_N_O_3')),
    unlocked: false,
  ...
  N_H_4_Cl: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('N_H_4_Cl')),
    unlocked: false,
  ...
  C_7_H_8: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_7_H_8')),
    unlocked: false,
  ...
  C_8_H_10_N_4_O_2: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_8_H_10_N_4_O_2')),
    unlocked: false,
  ...
  C_10_H_15_N: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_10_H_15_N')),
    unlocked: false,
  ...
  C_17_H_21_N_O_4: {
    ...
    requiredCounts: calculateRequiredCounts(parseMoleculeComposition('C_17_H_21_N_O_4')),
    unlocked: false,
